            ...
            <div class="row">
                    ...
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url({{ asset($product->avatar) }});">
                                </li>
                                @php $i=0; @endphp
                                @foreach(json_decode($product->images) as $key)
                                    @php $i++; @endphp
                                    <li data-target="#product_details_slider" data-slide-to="{{ $i }}" style="background-image: url({{ asset($key) }});">
                                </li>
                                @endforeach
                            </ol>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="{{ asset($product->avatar) }}">
                                        <img class="d-block w-100" src="{{ asset($product->avatar) }}" alt="First slide">
                                    </a>
                                </div>
                                @foreach(json_decode($product->images) as $key)
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="{{ asset($key) }}">
                                            <img class="d-block w-100" src="{{ asset($key) }}" alt="Second slide">
                                        </a>
                                    </div>
                                @endforeach
                            </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_product_desc">
                        ...
                        <h4 class="price">{{ $product->price }} AMD</h4>
