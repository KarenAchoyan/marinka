        ...
        <div class="container">
            <div class="row karl-new-arrivals">
               ...
               @foreach($products as $key)
                    <div class="modal fade" id="quickview{{ $key->id }}" tabindex="-1" role="dialog" aria-labelledby="quickview{{ $key->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                </button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-7">
                                                    <div class="quickview_pro_des">
                                                        ...
                                                        @if($key->discount!=0)
                                                        <h5 class="price">{{ $key->price }} AMD<span>{{ $key->discount }} AMD</span> </h5>
                                                        @else
                                                            <h5 class="price">{{ $key->price }}</h5>
                                                        @endif
                                                        <a href="{{ asset('/single/'.$key->id) }}">View Full Product Details</a>
                                                    </div>
                                                    <!-- Add to Cart Form -->
                                                    <form class="cart" method="post">
                                                        <div class="quantity">
                    ...
                    <div class="product-img">
                        ...
                        <div class="product-quicview">
                            <a href="#" data-toggle="modal" data-target="#quickview{{ $key->id }}"><i class="ti-plus"></i></a>
                        </div>
                    </div>
                    <!-- Product Description -->
                    <div class="product-description">
                        <h4 class="product-price">{{ $key->price }}</h4>
                        <p>{{ $key->name }}</p>
                        <!-- Add to Cart -->
                ...
                <div class="col-12 col-md-8">
                    <div class="karl-testimonials-slides owl-carousel">
                        ...
                        <div class="single-testimonial-area text-center">
                            <h3 class="">"Դավթաշեն"</h3>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d24383.0396501551!2d44.4989855!3d40.1894849!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1624886014451!5m2!1sen!2s" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>

                        <!-- Single Testimonial Area -->
                        <div class="single-testimonial-area text-center">
                            <h3 class="">"Հալաբյան"</h3>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d24383.0396501551!2d44.4989855!3d40.1894849!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1624886014451!5m2!1sen!2s" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
